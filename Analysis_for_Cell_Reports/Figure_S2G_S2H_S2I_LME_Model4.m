...
%Run linear mixed-effects analysis (Model 4) and plots Figure S2G, S2H, and S2I
...
%% Reaction time per valence; Figure S2G
...
saveas(gcf,fullfile(FigPath,'Figure_S2G_Blocked_VIM_Reaction_Time'),'jpeg');
...
%% Trials with responses per valence; Figure S2H
...
saveas(gcf,fullfile(FigPath,'Figure_S2H_Blocked_VIM_Responses'),'jpeg');

%% Set Y axis 

Yaxis = 1;

%% Accuracy per valence; Figure S2I
...
saveas(gcf,fullfile(FigPath,'Figure_S2I_Blocked_VIM_Accuracy'),'jpeg');
