...
%Run linear mixed-effects analysis (Model 4) and plots Figure S2D, S2E, and S2F
...
saveas(gcf,fullfile(FigPath,'Figure_S2D_Blocked_VIM_Reaction_Time'),'jpeg');
...
saveas(gcf,fullfile(FigPath,'Figure_S2E_Blocked_VIM_Responses'),'jpeg');
...
saveas(gcf,fullfile(FigPath,'Figure_S2F_Blocked_VIM_Accuracy'),'jpeg');
