...
%Run linear mixed-effects analysis (Model 9) and plots Figure S8E through S8H
...
saveas(gcf,fullfile(FigPath,'Figure_S8E'),'jpeg');
...
saveas(gcf,fullfile(FigPath,'Figure_S8F'),'jpeg');
...
saveas(gcf,fullfile(FigPath,'Figure_S8G'),'jpeg');
...
saveas(gcf,fullfile(FigPath,'Figure_S8H'),'jpeg');
