...
%Run linear mixed-effects analysis (Model 5) and plots Figure S3B
...
%% Z-score reaction times for model: do this by subject
...
%% Arousal plot for DA and 5HT; Figure S3B
...
saveas(gcf,fullfile(FigPath,'Figure_S3B_Random_VIM_DA_5HT'),'jpeg');