...
%Run linear mixed-effects analysis (Model 5) and plots Figure S4A
...
%% Make valence plots with DA, 5HT, NE; Figure S4A
...
saveas(gcf,fullfile(FigPath,'Figure_S4A_Blocked_VIM_DA_5HT_NE'),'jpeg');
