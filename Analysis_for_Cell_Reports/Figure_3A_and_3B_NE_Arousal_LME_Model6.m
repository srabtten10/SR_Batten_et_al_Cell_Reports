...
%Run categorical linear mixed-effects analysis for NE and arousal (Model 6)
...
for cc = 1:size(Model_Peak_Change,2)    
    Model_Table = table(categorical(Model_Subject),categorical(Model_Salience),Model_Rx_Time,...
                        Model_Peak_Change(:,cc),'VariableNames',datanames);
