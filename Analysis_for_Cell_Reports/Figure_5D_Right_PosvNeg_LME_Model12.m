...
%Run linear mixed-effects analysis (Model 12) for plots Figure 5D to look
%at right hemisphere only across valence
...
for cc = 1:size(Model_Peak_Change,2)    
    Model_Table = table(categorical(Model_Subject),categorical(Model_Valence),Model_Rx_Time,Model_Peak_Change(:,cc),...
