...
%Run linear mixed-effects analysis (Model 5) and plots Figure 3C and 3D
...
saveas(gcf,fullfile(FigPath,'Figure_3C_Bloked_VIM_NE'),'jpeg');

%% Figure 3 valence plots for DA/5HT
...
saveas(gcf,fullfile(FigPath,'Figure_3D_Blocked_VIM_DA_5HT'),'jpeg');